    ...
    <div className="rounded-xl border bg-card p-5 space-y-3">
      <div className="flex items-center justify-between">
        ...
        <motion.div
          ...
          className={cn("text-3xl font-sora font-bold", gradeColor(percentage))}
        >
          {percentage}%
        </motion.div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <span className={cn("text-lg font-sora font-bold min-w-[2rem] text-right", gradeColor(percentage))}>
