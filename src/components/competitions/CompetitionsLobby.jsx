        ...
        <TabsContent value="multiplayer" className="mt-0 space-y-6">
          ...
          <Card className="border-white/10 bg-[#111111]">
            <CardContent className="p-4">
              <p className="font-medium text-[#efefef]">Class Challenge</p>
              <p className="text-sm text-[#888] mt-1">
                Teacher creates a room, students join. Invite your class — coming soon.
              </p>
              <Button variant="ghost" size="sm" className="mt-2 text-[#6e5ff0]" disabled>
                Invite your class
              </Button>
            </CardContent>
          </Card>
