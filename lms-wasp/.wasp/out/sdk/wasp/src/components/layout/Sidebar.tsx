...
import {
  LayoutDashboard, ClipboardList, FlaskConical, BookOpen, Library,
  LogOut, GraduationCap, Brain, ChevronLeft, ChevronRight, ListTodo,
} from "lucide-react";
...
const teacherNav = [
  ...
  { href: "/teacher/tasks", label: "Tasks", icon: ListTodo },
  ...
  return (
    ...
    >
      ...
      <div className={cn(
        ...
        {!collapsed && (
          <div>
            <p className="font-semibold text-sm leading-tight" style={{ fontFamily: "Sora, sans-serif" }}>Visionary</p>
